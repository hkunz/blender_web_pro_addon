...
class WEB_OT_OperatorInstallChoco(OperatorScriptBase):
    ...
    def get_log_file(self):
        return os.path.join(FileUtils.get_addon_root_dir(), r'logs/install-choco.log')

    def get_script_path(self):
        return os.path.join(FileUtils.get_addon_root_dir(), r'utils/scripts/windows', 'install-choco.ps1')
    ...
    def handle_success(self, result, context):
        ...
        msg = f"Chocolatey is already installed!" if already_installed else f"Chocolatey installation complete!"
